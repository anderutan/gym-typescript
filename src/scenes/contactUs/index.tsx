      ...
      <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.ContactUs)}>
        ...
        <div className="mt-10 justify-between gap-8 md:flex">
          ...
          visible: { opacity: 1, y: 0 },
            ...
            onSubmit={onSubmit}
            method="POST"
            action="https://formsubmit.co/661aec457a0f28c895ee84d33abc815e"
            >
              <input type="text" placeholder="NAME" className={inputStyles} {...register('name', {
                required: true,
                maxLength: 100,
              })}/>
              {errors.name && (
              ...
              <input type="text" placeholder="EMAIL" className={inputStyles} {...register('email', {
                required: true,
              ...
              <textarea rows={4} cols={50} placeholder="MESSAGE" className={inputStyles} {...register('message', {
                required: true,
                maxLength: 2000,
              })}/>
              {errors.message && (
